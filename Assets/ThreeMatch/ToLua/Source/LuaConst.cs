...
{
    public static string luaDir = Application.dataPath + "/ThreeMatch/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/ThreeMatch/ToLua/Lua";        //tolua lua文件目录
