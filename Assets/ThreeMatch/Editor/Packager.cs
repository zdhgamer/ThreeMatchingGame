...
public class Packager {
    ...
    static UnityEngine.Object LoadAsset(string file) {
        ...
        return AssetDatabase.LoadMainAssetAtPath("Assets/ThreeMatch/Examples/Builds/" + file);
    }
    ...
    static void HandleAssetBundle() {
        ...
        AddBuildMap("gameprefabs" + AppConst.ExtName, "*.prefab", "Assets/Resources/Builds/GamePrefabs");

        AddBuildMap("prompt" + AppConst.ExtName, "*.prefab", "Assets/Resources/Builds/Panels/Prompt");
        AddBuildMap("message" + AppConst.ExtName, "*.prefab", "Assets/Resources/Builds/Panels/Message");
        ...
        AddBuildMap("update_asset" + AppConst.ExtName, "*.png", "Assets/Resources/Builds/UITextures/Bubbles");
    ...
    static void HandleLuaFile() {
        ...
        string[] luaPaths = { AppDataPath + "/ThreeMatch/lua/", 
                              AppDataPath + "/ThreeMatch/Tolua/Lua/" };
