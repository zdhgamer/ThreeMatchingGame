...
public class Packager {
    ...
    static UnityEngine.Object LoadAsset(string file) {
        ...
        return AssetDatabase.LoadMainAssetAtPath("Assets/TileMatching/Examples/Builds/" + file);
    }
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("prompt" + AppConst.ExtName, "*.prefab", "Assets/TileMatching/Examples/Builds/Prompt");
        AddBuildMap("message" + AppConst.ExtName, "*.prefab", "Assets/TileMatching/Examples/Builds/Message");

        AddBuildMap("prompt_asset" + AppConst.ExtName, "*.png", "Assets/TileMatching/Examples/Textures/Prompt");
        AddBuildMap("shared_asset" + AppConst.ExtName, "*.png", "Assets/TileMatching/Examples/Textures/Shared");
    }
    ...
    static void HandleLuaFile() {
        ...
        string[] luaPaths = { AppDataPath + "/TileMatching/lua/", 
                              AppDataPath + "/TileMatching/Tolua/Lua/" };
